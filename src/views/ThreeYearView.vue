<template>
  <div class="three-year-view">
    <h2>{{ periodRange.start.getFullYear() }} - {{ periodRange.end.getFullYear() }} 三年里程碑</h2>
...
const periodRange = computed(() => ({
  start: getPeriodStart(viewStore.currentDate, TimeLevel.THREE_YEAR),
  end: getPeriodEnd(viewStore.currentDate, TimeLevel.THREE_YEAR)
}))
...
const items = computed(() => planningStore.getItemsByLevel(TimeLevel.THREE_YEAR))
