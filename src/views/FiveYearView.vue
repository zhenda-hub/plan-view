<template>
  <div class="five-year-view">
    <h2>{{ periodRange.start.getFullYear() }} - {{ periodRange.end.getFullYear() }} 五年规划</h2>
...
const periodRange = computed(() => ({
  start: getPeriodStart(viewStore.currentDate, TimeLevel.FIVE_YEAR),
  end: getPeriodEnd(viewStore.currentDate, TimeLevel.FIVE_YEAR)
}))
...
const items = computed(() => planningStore.getItemsByLevel(TimeLevel.FIVE_YEAR))
